---
title: AI Prompt - Modulating Valve FB
version: 0.1.1
...
Modulating valve (4-20mA position control):
  - Setpoint % (0-100)
  - Setpoint → AO scaling
  - Position feedback (AI 4-20mA)
  - Setpoint deviation timeout
